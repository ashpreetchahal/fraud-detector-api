# app/fraud_detector.py
from datetime import datetime, timedelta
from typing import List, Dict

# We'll keep a simple in-memory store for demo purposes
...
def rule_suspicious_location(location: str, blacklist: List[str] = None) -> bool:
    if blacklist is None:
        blacklist = {"NG", "RU", "CN"}  # Example country codes
...
def detect_fraud(transaction: dict) -> bool:
    ...
    if not timestamp_str:
        # Can't check time-based rules without timestamp
        return False
